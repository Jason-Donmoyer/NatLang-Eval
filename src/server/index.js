...
// Server port
app.listen(PORT, () => {
    console.log(`server is hot to trot and ready to rock on port: ${PORT}`);
});
...
// //     let url = `${baseApiUrl}${ApiKey}&lang=auto&url=${req.body}`;
// //     console.log(url);
// //     const response = await fetch(`${baseApiUrl}${ApiKey}&lang=auto&url=http://www.twitter.com`);
